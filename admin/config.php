<?php
// HTTP
define('HTTP_SERVER', 'http://www.gotobookshop.com/admin/');
define('HTTP_CATALOG', 'http://www.gotobookshop.com/');

// HTTPS
define('HTTPS_SERVER', 'http://www.gotobookshop.com/admin/');
define('HTTPS_CATALOG', 'http://www.gotobookshop.com/');

// DIR
define('DIR_APPLICATION', '/var/app/current/admin/');
define('DIR_SYSTEM', '/var/app/current/system/');
define('DIR_IMAGE', '/var/app/current/image/');
define('DIR_LANGUAGE', '/var/app/current/admin/language/');
define('DIR_TEMPLATE', '/var/app/current/admin/view/template/');
...
define('DIR_CATALOG', '/var/app/current/catalog/');
