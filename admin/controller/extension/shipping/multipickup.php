<?php
class ControllerExtensionShippingmultipickup extends Controller {
	private $error = array();
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/shipping/multipickup', 'token=' . $this->session->data['token'], 'SSL')
		);

		$data['action'] = $this->url->link('extension/shipping/multipickup', 'token=' . $this->session->data['token'], 'SSL');
		
		$data['refresh'] = $this->url->link('extension/shipping/multipickup', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('extension/shipping/multipickup', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'extension/shipping/multipickup')) {
